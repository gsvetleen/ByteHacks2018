...
class ImageOptions: UIViewController {
    ...
    @IBOutlet weak var slouchy: UIButton!
    @IBOutlet weak var tiffany: UIButton!
    @IBOutlet weak var stripped: UIButton!
    var emptyDict:[String:String] = ["BirdHouse": """
    ...
    @IBAction func birdHouseAction(_ sender: Any) {
        print(String(describing: bird.titleLabel!.text))
        func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            // get a reference to the second view controller
            let secondViewController = segue.destination as! imageAndText
            secondViewController.image = String(describing: (bird.titleLabel!.text))
            secondViewController.textWithImage = emptyDict[String((bird.titleLabel!.text)!)]!
            
        }
    }
    
    @IBAction func bowTieAction(_ sender: Any) {
        
        func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            // get a reference to the second view controller
            let secondViewController = segue.destination as! imageAndText
            secondViewController.image = (bow.titleLabel?.text)!
            secondViewController.textWithImage = emptyDict[(bow.titleLabel?.text)!]!
            
        }
    }
    
    @IBAction func BrownScarfAction(_ sender: Any) {
        func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            // get a reference to the second view controller
            let secondViewController = segue.destination as! imageAndText
            secondViewController.image = (brown.titleLabel?.text)!
            secondViewController.textWithImage = emptyDict[(brown.titleLabel?.text)!]!
            
        }
    }
    
    @IBAction func gardenBenchAction(_ sender: Any) {
        func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            // get a reference to the second view controller
            let secondViewController = segue.destination as! imageAndText
            secondViewController.image = (garden.titleLabel?.text)!
            secondViewController.textWithImage = emptyDict[(garden.titleLabel?.text)!]!
            
        }
    }
    
    @IBAction func grayHat(_ sender: Any) {
        func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            // get a reference to the second view controller
            let secondViewController = segue.destination as! imageAndText
            secondViewController.image = (gray.titleLabel?.text)!
            secondViewController.textWithImage = emptyDict[(gray.titleLabel?.text)!]!
            
        }
    }
    @IBAction func redHat(_ sender: Any) {
        func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            // get a reference to the second view controller
            let secondViewController = segue.destination as! imageAndText
            secondViewController.image = (red.titleLabel?.text)!
            secondViewController.textWithImage = emptyDict[(red.titleLabel?.text)!]!
            
        }
    }
    @IBAction func SlouchyHat(_ sender: Any) {
        func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            // get a reference to the second view controller
            let secondViewController = segue.destination as! imageAndText
            secondViewController.image = (slouchy.titleLabel?.text)!
            secondViewController.textWithImage = emptyDict[(slouchy.titleLabel?.text)!]!
            
        }
    }
    @IBAction func StrippedHat(_ sender: Any) {
        func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            // get a reference to the second view controller
            let secondViewController = segue.destination as! imageAndText
            secondViewController.image = (stripped.titleLabel?.text)!
            secondViewController.textWithImage = emptyDict[(stripped.titleLabel?.text)!]!
            
        }
    }
    @IBAction func TiffanyBlueAction(_ sender: Any) {
        func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            
            // get a reference to the second view controller
            let secondViewController = segue.destination as! imageAndText
            secondViewController.image = (tiffany.titleLabel?.text)!
            secondViewController.textWithImage = emptyDict[(tiffany.titleLabel?.text)!]!
